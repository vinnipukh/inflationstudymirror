...
Computes three inflation metrics for Samsung Türkiye SKUs:
  ...
  3. TUIK Weighted Avg – weighted average using TUIK 2026 CPI basket weights,
                         all Samsung products default to group 08 (Haberleşme)

Data format: product_name, price (2 columns)

Output Files:
- samsung_inflation_YYYY-MM-DD.csv – Detailed per-product data with basic_inflation columns
