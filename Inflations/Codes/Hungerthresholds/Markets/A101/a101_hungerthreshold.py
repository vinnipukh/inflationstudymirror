...
MATCH_RULES = {
    ...
    "Chicken": {
        ...
        "exclude": ["Döner", "Nugget", "Şinitzel", "Sarma", "Köfte", "Kroket", "Çıtır",
                    ...
                    "Bulyon","Salam","Pilav","Cips","Çeşni","Baharat","Çorba","Jambon",
                    "Çabuk","Yumurta","Tavuk Göğsü"],
        "unit": "kg",
    },
    "Fish": {
        "keywords": ["Hamsi", "Levrek", "Somon", "Balık"],
        "exclude": ["Füme", "Konserve", "Kedi", "Köpek", "Maması", "Sosu", "Soslu",
                    "Kraker","Çikolata","Şeker","Mama","Tava","Hayvan"],
        "unit": "kg",
    },
    "Eggs": {
        "keywords": ["Yumurta"],
    ...
    "Seasonal Fruit": {
        "keywords": ["Çilek", "Kiraz", "Vişne", "Kayısı", "Şeftali",
                     "Erik", "İncir", "Üzüm", "Nar", "Kivi", "Kavun", "Karpuz",
                     "Elma","Portakal","Mandalina"],
        "exclude": ["Muz", "Limon", "Avokado", "Suyu", "File", "Paket", "Kutu",
                    "Dondurulmuş", "Püre", "Konserve","Şeker","Atıştırmalık","Çikolata",
                    "Aromalı","Sakız","Salam","Reçel","Gofret","Pekmez","Kurabiye",
                    "İçecek","Şeker","Çay","Şölen","Ülker","Lolipop","Kefir","Süt",
                    "Peynir","Milkshake","Deterjan","Sabun","Şampuan","Freedo","Un","Kek",
                    "Cips","Sosis","Elseve","Garnier","Elidor","Aroma","Draje","Pınar",
                    "Nektarı","Bisküvi","Narbaharat","Sirke","Kuruyemiş","Sleepy","Sprey",
                    "Merhem","Sek","Activia","Kemal","Kuru","Sos","Gevrek","Parçacıklı",
                    "Fanta","Temizlik","Mama","Bar","Kreması","Protein","Kuş","Kağıt",
                    "Pestil","İçeceği","Topu","Kahve","Algida","Krem","Yağı","Bi",
                    "Gazoz","Narenciye","Tada","Brillant","Somon","Tsuyoi"],
        "unit": "kg",
    },
    "Onion": {
        "keywords": ["Soğan Kg"],
...
print("="*65)
print(f"  {'Date':<12} {'Avg (₺)':>16}  {'Median (₺)':>16}  {'MoM Avg':>8}  {'MoM Median':>10}")
...
for _, r in summary_df.iterrows():
    ...
    print(f"  {r['date']:<12} ₺{r['avg_hunger_threshold_TRY']:>14,.2f}  ₺{r['median_hunger_threshold_TRY']:>14,.2f}  {mom_avg:>8}  {mom_med:>10}")
