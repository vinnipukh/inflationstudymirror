...
MATCH_RULES = {
    ...
    "Chicken": {
        ...
        "exclude": ["Döner", "Nugget", "Şinitzel", "Sarma", "Köfte", "Kroket", "Çıtır",
                    ...
                    "Jambon", "Çabuk", "Yumurta","Tavuk Göğsü","Püre","Pouch","Ödül",
                    "Izgara","Pane","Harcı"],
        "unit": "kg",
    },
    "Fish": {
    ...
    "Eggs": {
        ...
        "exclude": ["Organik", "Bıldırcın", "Toz", "Akı", "Sarısı", "Şeker", "Haribo",
                    "Çikolata", "Sürpriz","Süpriz","Fırça","Ozibox","Elvan","Yumurtalı",
                    "Ozmo","Ülker"],
        "unit": "piece",
    },
    "Chickpeas": {
    ...
    "Seasonal Fruit": {
        ...
        "exclude": ["Muz", "Limon", "Avokado", "Suyu", "File", "Paket", "Kutu",
                    ...
                    "Pekmez", "Kurabiye", "İçecek", "Şeker", "Çay", "Şölen", "Ülker",
                    "Lolipop", "Kefir", "Süt", "Peynir", "Milkshake", "Deterjan",
                    "Sabun", "Şampuan", "Freedo", "Un", "Kek", "Cips", "Sosis",
                    "Elseve", "Garnier", "Elidor", "Aroma", "Draje", "Pınar", "Nektarı",
    ...
    "Onion": {
        ...
        "exclude": ["Taze", "Pırasa", "Toz", "Pul", "Sarımsak", "Halkası","Cips",
                    "Çerezza","Eti","Tatlı","Ülker","Cheetos"],
        "unit": "kg",
    },
    "Eggplant / Zucchini": {
    ...
    "Olive Oil": {
        ...
        "exclude": ["Spreyı", "Sprey", "Zeytinyağlı", "Sabun", "Krem","Sleepy","Saç",
                    "Şampuan"],
        "unit": "ml_or_L",
    },
    "Grissini": {
