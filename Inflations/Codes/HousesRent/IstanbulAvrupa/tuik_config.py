"""
tuik_config.py — TUIK CPI basket weights and IstanbulAvrupa category mapping.
...
Provides:
  ...
  - istanbul_avrupa_category_to_tuik(): always returns TUIK group 04 (Konut)
"""
...
# ─── IstanbulAvrupa Category → TUIK Group ────────────────────────────────────
def istanbul_avrupa_category_to_tuik(_category_name=None):
    """IstanbulAvrupa is housing rent → always TUIK group 04."""
    return "04"
