...
Computes three inflation metrics for Rossmann products:
  ...
  3. TUIK Weighted Avg – weighted average using TUIK 2026 CPI basket weights,
                         all Rossmann products default to group 12 (Kişisel bakım)

Data format: product_name, price (2 columns)

Output Files:
- rossmann_inflation_YYYY-MM-DD.csv – Detailed per-product data with basic_inflation columns
...
TUIK_CATEGORY = "12"  # Kişisel bakım
