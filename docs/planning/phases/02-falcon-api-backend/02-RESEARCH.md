...
- `inflation_dashboard/adapters/csv_price_repository.py` discovers supported CSV inventory and loads bounded price history from `InflationItems/Datas/`.
...
- Scraper or data files under `InflationItems/Codes/`, `InflationItems/Datas/`, `Inflations/`.
